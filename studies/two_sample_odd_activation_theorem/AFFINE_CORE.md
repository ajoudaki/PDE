# Odd two-input extension: symmetry and the uniform affine core
...
\]
The shifted-activation nonlinear response lemma is not assumed to apply.
Response and finite-width bridges must separately be checked with
constant affine gate \(a\).
...
\le\frac{v_v}{n}\|T_n\|_{\rm op}^2\|p_n\|_n^2. \tag{13}
\]
