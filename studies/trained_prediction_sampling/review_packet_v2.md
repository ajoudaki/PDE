# Neutral complete adversarial review assignment — version 2

Review the proposed canonical addition `proposal_C4_8_v2.md` and the exact related
summary edits in `promotion_edits_v2.json` for mathematical correctness and scope.
...
|---|---|---|
| studies/trained_prediction_sampling/proposal_C4_8_v2.md | all 1552 lines | 98fa7614b6449b58b07c65df047b68a3484bf0760b36a3a25052f67d72692928 |
| studies/trained_prediction_sampling/promotion_edits_v2.json | all | 50a95f4576c56c1438974a76da25a793ebe188e39c00e2f98f79bd79cb294f2c |
...
Reviewer A writes only `studies/trained_prediction_sampling/review_v2_A.md`;
reviewer B writes only `studies/trained_prediction_sampling/review_v2_B.md`.
Each uses its matching `data/generated/trained_prediction_sampling/review_v2_A/`
or `review_v2_B/` scratch. The sampling check additionally requires its output
