...
def write_result(unit: IndependentResult, directory: Path) -> dict[str, str]:
    raise RuntimeError("archive-only coefficient/seal writer; use the pure compiler without regenerating the retained freeze")
...
if __name__ == "__main__":
    raise RuntimeError("archive-only coefficient freeze entry point; no compilation or seal writes authorized by migration")
