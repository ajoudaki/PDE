...
\]
For every fixed dimension \(d\ge2\), in the range \(0<\delta\le1/4\) and \(0<e\le1/2\), the worst-case first-feature minimum eigenvalue is \(\Theta(e^2\delta^2)\), up to absolute constants. This is a small-separation assertion; it is not claimed at \(\delta=1\). Thus the initial
