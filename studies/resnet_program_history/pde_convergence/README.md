...
1. [`01_proof_audit`](../../resnet_proof_audit) contains the proof-obligation
   ...
   completed.
2. [`02_lean_salvage`](../../resnet_lean_salvage) contains the bounded follow-up
...
3. [`03_bridgeability`](../../resnet_bridgeability) repairs the even-shell parity flaw
...
4. [`04_scalar_stress`](../../resnet_scalar_stress) is the one-input Hermite ladder.
5. [`05_tail_and_compactness`](../../resnet_tail_compactness) combines the
