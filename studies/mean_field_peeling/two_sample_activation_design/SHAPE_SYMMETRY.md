...
- `two_sample_odd_activation_power10/NORMALIZED_GATES_AND_PRIMALS.md`, for exact transformed equations only; the required original-time moment differences are proved directly in LINEAR_GROWTH.md, Section 4;
