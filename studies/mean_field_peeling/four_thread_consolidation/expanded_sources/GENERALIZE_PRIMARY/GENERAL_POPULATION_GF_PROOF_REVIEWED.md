...
Status: complete theorem framework; the response lemma is being independently
checked in GENERAL_DEPTH_RESPONSE_PROOF.md. This status line will be updated only
after the written proof and that lemma have passed adversarial review.
...
For L=2, squared loss, zero limiting readout, positive sigma_1,sigma_2 and
