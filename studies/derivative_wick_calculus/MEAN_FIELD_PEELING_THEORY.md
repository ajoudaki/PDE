...
## 11. Backward-kernel laboratory: what the first execution establishes
...
## 12. Feature-learning jets

### 12.1 Gradient-flow derivatives
...
### 12.2 Discrete gradient descent
...
### 12.3 What a jet does not prove
...
## 13. Target theorem and its strengthenings

### 13.1 Conservative target
...
### 13.2 Finite-state strengthening
...
### 13.3 Possible batch-dimensional factorization
...
## 14. Claim ladder and relation to Tensor Programs
...
### 14.1 What recursive Tensor Program semantics already provides
...
Equation (14.4) is itself a proposed equivalence theorem, not an assumption.
...
## 15. Amendments forced by the executions
...
13. **Tensor Programs equivalence.** Prove (14.4) on the overlap class as a
    validation theorem.
...
## 19. Terminology, framing, and literature anchors
...
## 20. Current authoritative positioning
...
The fixed three-hidden-layer backward expectation and detailed training
calculations provide the present laboratory. The general nonlinear two-step
closure is formal, its deep-linear specialization is audited, and the
finite-state theorem for the full proposed admissible grammar remains open.
This status must remain visible as the theory develops.
