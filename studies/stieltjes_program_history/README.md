...
are in [resolution_program](../stieltjes_resolution), with the high-order
successor in
[canonical_high_order](../stieltjes_resolution/canonical_high_order).  These are
...
norms in
[canonical_hidden_high_order](../stieltjes_resolution/canonical_hidden_high_order).
...
Separately, the
[generic-activation compiler](../mfp_gaussian_calculus/README.md)
...
separate [mean-field peeling study](../mfp_program_history).

Directory map:

- [theory](../stieltjes_theory_history) contains exact transformations, Hankel certificates,
...
- [resolution_program](../stieltjes_resolution) contains the target contract,
...
- the five compiler-local parameter-campaign directories in
  [mean-field peeling](../mfp_quadratic_compiler) retain their
