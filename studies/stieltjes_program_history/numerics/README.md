...
- [`direct_loewner/`](../../stieltjes_direct_loewner) records the initial direct Loewner and
  common-clock investigations;
- [`finite_width/`](../../stieltjes_finite_width) records the later preregistered calibration,
  stopped-flow, and order-thirteen pilot experiments;
- [`global_proxy_campaign/`](../../stieltjes_proxy_campaign) records the exact
  Lambert-$W$ rational-hierarchy calibration and the closed canonical
  finite-width global-curve pilot. Its [terminal result](../../stieltjes_proxy_campaign/RESULTS.md)
...
- [`hybrid_mean_field_campaign/`](../../stieltjes_hybrid_campaign) records the
  subsequent direct-width/DMFT route audit, [bounded DMFT Stage 0](../../stieltjes_hybrid_campaign/bounded_dmft/STAGE0_REPORT.md),
  the stopped [FP32 Euler qualification](../../stieltjes_hybrid_campaign/width_ladder/euler_fp32/STAGE_V_REPORT.md), and a
  separately frozen [breadth-first panel](../../stieltjes_hybrid_campaign/breadth_panel/RESULTS.md)
  ...
  [FP64 local successor](../../stieltjes_hybrid_campaign/breadth_panel/fp64_successor/RESULTS.md)
  ...
  [FP64 n=4096 successive-proxy experiment](../../stieltjes_hybrid_campaign/breadth_panel/successive_n4096/RESULTS.md)
  ...
  [FP64 n=8192 successor](../../stieltjes_hybrid_campaign/breadth_panel/successive_n8192/RESULTS.md)
