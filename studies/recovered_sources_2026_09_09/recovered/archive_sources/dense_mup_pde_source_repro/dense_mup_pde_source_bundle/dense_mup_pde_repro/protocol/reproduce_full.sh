...
cd "$archive_root"
"$python_bin" agent_outputs/numerics/paired_w_variance.py \
...
cd "$archive_root"
"$python_bin" agent_outputs/statistical_audit/analyze.py
"$python_bin" agent_outputs/statistical_audit/reference_noise_update.py
"$python_bin" agent_outputs/statistical_audit/ordered_limit_update.py
