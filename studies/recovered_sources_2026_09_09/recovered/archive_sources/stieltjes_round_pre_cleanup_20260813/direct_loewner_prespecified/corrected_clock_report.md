...
```text
python run_corrected_clock_test.py
```
...
- `clock_pilot_20260813/`: validity-only pilot, distinct seeds.
- `run_corrected_clock_test.py`: independent scientific runner.
- `corrected_clock_run_20260814/summary.json`: complete numerical summaries,
  matrices, sensitivities, confidence bounds, and controls.
- `corrected_clock_run_20260814/raw_width_*.npz`: per-pair raw curves.
- `corrected_clock_run_20260814/half_step_width_*.npz`: step-halving data.
- `corrected_clock_run_20260814/bootstrap_scores_width_*.npz`: raw held-out
  bootstrap scores.
- `corrected_clock_run_20260814/primary_proxy_width_*.npz`: `F`, `G`, and
  primary matrices.
- `corrected_clock_run_20260814/run.log`: exact run log.
- `corrected_clock_run_20260814/manifest.json`: hashes and byte sizes.
