...
from exact_peeling.finite_width_jet_reference import feature_jet  # noqa: E402


HERE = Path(__file__).resolve().parent
PROTOCOL = HERE / "FRESH_CALIBRATED_RATIO_PROTOCOL.md"
CERTIFICATE = ROOT / "studies/formal_stieltjes/certificates_order11.json"
OUT = HERE / "fresh_calibrated_ratio_run"
WIDTHS = (128, 256)
COUNT = 512
BOOTSTRAPS = 20_000
...
def main() -> None:
    ...
    result: dict = {
        ...
        "provenance": {
            ...
            "finite_width_recurrence_sha256": sha256(
                ROOT / "exact_peeling/finite_width_jet_reference.py"),
    ...
    (OUT / "run_command.txt").write_text(
        ...
        "python empirical_redesign/run_fresh_calibrated_ratio.py\n")
    print(encoded)
