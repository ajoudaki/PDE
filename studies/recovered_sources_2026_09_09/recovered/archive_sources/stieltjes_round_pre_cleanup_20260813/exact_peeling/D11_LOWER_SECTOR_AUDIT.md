...
`exact_peeling/exhaustive_reference.cpp`.  It is byte-identical to the source
...
This is also the evaluator hash frozen in `exact_peeling/source_hashes.txt`.
...
```text
exact_peeling/export_evaluator_checked512
...
`studies/formal_stieltjes/REPORT.md` predates these completed computations.  Its
...
newer `studies/formal_stieltjes/derivatives_order11.json` contains the correct
