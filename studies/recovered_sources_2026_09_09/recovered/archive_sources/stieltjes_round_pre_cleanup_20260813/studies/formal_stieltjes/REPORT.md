...
> `exact_peeling/D11_LOWER_SECTOR_AUDIT.md`,
> `exact_peeling/d11_high_sectors_exact.txt`, and
> `studies/formal_stieltjes/certificates_order11.json`.  The historical text
...
```bash
python studies/formal_stieltjes/exact_graph_wick.py \
  --max-order 5 \
  --output studies/formal_stieltjes/derivatives_order5.json
```

Independent checks:

```bash
python studies/formal_stieltjes/independent_checks.py \
...
```bash
python studies/formal_stieltjes/stieltjes_certificates.py \
  studies/formal_stieltjes/derivatives_order5.json \
  --output studies/formal_stieltjes/certificates_order5.json
```
...
g++ -O3 -std=c++20 -march=native \
  studies/formal_stieltjes/peeling_lower_bound.cpp \
...
g++ -O3 -std=c++20 -march=native -fopenmp \
  studies/formal_stieltjes/leading_wick_jet_forest.cpp \
