...
![Depth initialization scaling](../results/final/depth_initialization_scaling.png)
...
![Truncated response training errors](../results/final/truncated_training_errors.png)
...
![Response singular values](../results/final/response_singular_value_decay.png)

![Triangular Galerkin diagnostic](../results/final/triangular_galerkin_projection.png)
...
- `deliverables/REPRODUCE.md` and `requirements.txt`;
...
- `src/run_response_galerkin_projection.py` — raw triangular projection
  diagnostic;
- `results/final/scaling_audit.json`;
