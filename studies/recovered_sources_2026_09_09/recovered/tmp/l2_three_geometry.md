...
\]
The population readout initializes at zero. Write \(A\) for the one adjacent action, \(h_i^1=\phi(z_i^1)\), \(z_i^2=Ah_i^1\), \(h_i^2=\phi(z_i^2)\), and \(f_i=\langle C,h_i^2\rangle\). Every statement below also has its finite-width normalized-inner-product version when it refers to a parameter state.
...
\[
\boxed{Q_2(0)\succeq a^2e^2b_3^2\frac{\delta^2(2-\delta)^2}{3}I_3.} \tag{3}
\]
