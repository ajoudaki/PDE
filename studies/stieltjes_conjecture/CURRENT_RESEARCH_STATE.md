...
| Shallow dynamical compression | Each neuron has an exact two-dimensional Riccati characteristic; the population transport/integral representation is formal for Gaussian data and rigorous for compactly supported laws before a common pole. No closed finite-state aggregate loss ODE or ordinary positive-time Gaussian population curve is established |
