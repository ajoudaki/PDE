#!/usr/bin/env python3
"""Run one existing 8-lineage n=8192 block with the validated FP64 engine."""
...
def main() -> int:
    ...
    point = {
        "key": f"{args.configuration}_n8192_L{args.lineage_start}_{args.lineage_stop}",
    ...
    manifest = {
        "schema": "breadth-successive-n8192-block-result-v1",
        "status": "complete",
