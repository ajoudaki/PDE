# residual continuous depth gradient flow
...
- [CONSTANT_SPECIES_GENERAL_ACTIVATION_IDE.md](CONSTANT_SPECIES_GENERAL_ACTIVATION_IDE.md)
- [GENERAL_ACTIVATION_CONSTANT_SPECIES_AUDIT.md](GENERAL_ACTIVATION_CONSTANT_SPECIES_AUDIT.md)
- [RESNET_MEAN_FIELD_IDE_THEOREM.md](RESNET_MEAN_FIELD_IDE_THEOREM.md)
