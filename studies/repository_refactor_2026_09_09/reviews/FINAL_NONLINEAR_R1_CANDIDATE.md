...
The candidate has 46 proof units after the common lemmas. They are organized as follows.
...
The common numerical H from the reference power-ten proof obeys
...
The bounded-memory identities hold on any existing strong path with the displayed bounded activation and zero population readout; the finite version includes the actual initial readout term. The coordinate obstruction concerns simultaneous straightening for arbitrary controls. The fitting lower bounds are conditional necessary conditions for successful training of the stated three-input near-identity family. None of these statements asserts a new global population construction.
