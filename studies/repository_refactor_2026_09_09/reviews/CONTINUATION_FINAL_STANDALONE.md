# Final standalone scientific validation

The isolated 27-file scientific snapshot contains no studies, data, prior reviews or PDF exporter. The independent reviewer ran the following checks on the unchanged final input manifest. These are finite deterministic implementation checks, not training or population experiments.

## Scientific make check

```text
python -B code/tools/check_library.py
Library boundary and local links checked: 25 files.
make test
make[1]: Entering directory '/tmp/pde_continuation_integration_1'
...
----------------------------------------------------------------------
Ran 86 tests in 0.432s

OK
make[1]: Leaving directory '/tmp/pde_continuation_integration_1'
```

## New guide examples and environment

```text
Python: 3.10.12 (main, Jun 22 2026, 18:55:27) [GCC 11.4.0]
NumPy: 1.26.4

EXAMPLE: Finite quadratic and RMS reductions
[0.0346     0.07703125 0.1140625 ] [0.00843756 0.05290351 0.19226667]
PASS

EXAMPLE: Exact Euler pullback words
PASS
```
