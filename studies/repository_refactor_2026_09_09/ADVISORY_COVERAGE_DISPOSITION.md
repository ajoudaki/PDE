...
| 9. Further negatives and finite reductions | Restricted linear bounded-contraction nonclosure; some norm/jet obstructions; general finite energy continuation | Sections 5–7 contain QI/IQ/QQ and RMS identities and APIs. Sections 8–9 now contain the arbitrary-vanishing-mesh frozen quadratic initial layer, exact frozen evaluator/step, deletion counterexample, reached finite ReLU classical obstruction, positive local ReLU Euler output compactness and exact frozen-gate occupations. The fully trained quadratic adaptive bridge and generalized ReLU identification remain unresolved; deterministic reachable Hessian examples are not typical-Gaussian counterexamples. |
