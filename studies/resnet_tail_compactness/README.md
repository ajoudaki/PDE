...
- [COMPACTNESS_MANIFEST.md](COMPACTNESS_MANIFEST.md)
- [COMPACTNESS_REPORT.md](COMPACTNESS_REPORT.md)
- [TAIL_MANIFEST.md](TAIL_MANIFEST.md)
- [TAIL_REPORT.md](TAIL_REPORT.md)
