...
OUT=REPO/'data/generated/nonlinear_prediction_selection/standalone_v2'
if OUT.exists():
    raise SystemExit('Fresh output required; existing standalone_v2 preserved.')
OUT.mkdir(parents=True)
def sha(p): return hashlib.sha256(p.read_bytes()).hexdigest()
review=json.loads((STUDY/'REVIEW_MANIFEST_v2.json').read_text())
...
proposal=json.loads((STUDY/'PROPOSED_EDITS_v2.json').read_text())
