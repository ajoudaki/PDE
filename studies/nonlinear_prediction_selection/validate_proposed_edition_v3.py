...
OUT=REPO/'data/generated/nonlinear_prediction_selection/standalone_v3'
if OUT.exists():
    raise SystemExit('Fresh output required; existing standalone_v3 preserved.')
...
proposal=json.loads((STUDY/'PROPOSED_EDITS_v3.json').read_text())
