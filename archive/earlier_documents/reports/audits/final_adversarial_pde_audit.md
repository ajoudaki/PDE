...
- `dense_mup_pde_repro/src/dense_pde/operator_galerkin.py`;
- `dense_mup_pde_repro/run_pde.py`;
- `dense_mup_pde_repro/theory/operator_galerkin_pde.md`;
...
- the independent derivation, numerical implementation, statistical
  analysis, and earlier hostile audit under `agent_outputs/`;
